...
// This method creates a filter box to filter the orgnanzation appears on the screen
class SearchResults extends React.Component {
  ...
  //This function filters the organization so that organizations are sorted based on the sorting selected of the all org filters
  onSortFilterChange = function (value){
    this.setState({sorting:value});
  };

  //This function filters the organization so that only ones of a certain type appear on the screen of all org filters
  onTypeFilterChange = function(value) {
    this.setState({typeFilter:value});
  };

  //This function filters the organization so that only ones within the distance appear on the screen of all org filters
  ...
  //This function handles the reset of the filter param and returns them to the default params of all org filters
  ...
  render() {
    ...
    let msoeCC = {latitude:43.044004,longitude:-87.909020}; // Default location of Connor Hibbs, to use to calculate distances with other organizations
